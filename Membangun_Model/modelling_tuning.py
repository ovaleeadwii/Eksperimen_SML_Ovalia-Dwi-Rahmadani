...
mlflow.set_experiment("Diabetes Classification Tuning Manual")
...
with mlflow.start_run(run_name="RandomForest_Manual_Tuning_With_Artifacts"):
    ...
    # =========================
    # 8. Simpan Model sebagai .pkl
    # =========================

    model_pkl_path = os.path.join(base_dir, "random_forest_model.pkl")
    joblib.dump(best_model, model_pkl_path)
    mlflow.log_artifact(model_pkl_path)

    # =========================
    # 9. Artifact: Confusion Matrix
    # =========================
    ...
    # =========================
    # 10. Artifact: Classification Report
    # =========================
    ...
    # =========================
    # 11. Artifact: Feature Importance
    # =========================
    ...
    print("Model pkl berhasil disimpan:", model_pkl_path)
    print("Artifact berhasil dicatat ke MLflow.")
